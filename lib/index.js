...
class Connector {
	constructor (opts) {
		...
		if ('pagination' in opts && opts.pagination) {
			this.pagination = Object.assign({}, opts.pagination);
		};
		if (! this.pagination.default) this.pagination.default = cfg.default.paginationDefault;
		if (! this.pagination.max) this.pagination.max = cfg.default.paginationMax;
